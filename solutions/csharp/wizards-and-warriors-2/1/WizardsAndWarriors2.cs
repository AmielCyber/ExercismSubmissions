...
static class GameMaster
{
    ...
    public static string Describe(TravelMethod travelMethod) =>
        $"You're traveling to your destination {GetTravelMethodDescription(travelMethod)}.";
    ...
    private static string GetTravelMethodDescription(TravelMethod travelMethod) =>
