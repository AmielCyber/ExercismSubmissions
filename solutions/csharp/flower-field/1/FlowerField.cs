...
public static class FlowerField
{
    public static string[] Annotate(string[] input)
    {
        ...
        return FlowerCountArrayToFlowerFieldStringArray(input, flowerCount);
    }
    ...
    private static string[] FlowerCountArrayToFlowerFieldStringArray(string[] input, int[][] flowerCount)
    {
