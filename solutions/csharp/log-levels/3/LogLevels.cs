static class LogLine
{
    ...
    public static string LogLevel(string logLine)
    {
        ...
        if (LogLevelExists(levelStartIndex, levelEndIndex, logLine.Length))
            return GetLevelString(logLine, levelStartIndex, levelEndIndex);
        return logLine;
    }
    ...
    private static string GetLevelString(string logLine, int levelStartIndex, int levelEndIndex) =>
        logLine.Substring(levelStartIndex + 1, levelEndIndex - levelStartIndex - 1).ToLower();
}
