...
private:
  ...
  int year;
  boost::gregorian::date GetDaySchedule(Schedule schedule, boost::gregorian::greg_weekday weekday) const;
  boost::gregorian::date GetNthWeekday(Schedule schedule, boost::gregorian::greg_weekday weekday) const;
  boost::gregorian::date GetTeenthWeekday(boost::gregorian::greg_weekday weekday) const;
